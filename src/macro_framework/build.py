      ...
      plugins: {{
        ...
        annotation: {{
          annotations: {{
            ...
            cautionBand: {{ type: 'box', yMin: {MRMI_CASH_THRESHOLD:.2f}, yMax: {MRMI_LONG_THRESHOLD:.2f}, backgroundColor: 'rgba(205,170,106,0.22)', borderColor: 'rgba(205,170,106,0.34)', borderWidth: 1, scaleID: 'y' }},
